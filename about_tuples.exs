...
defmodule About_Tuples do
  ...
  think "Can reach tuple element with index using kernel elem function" do
    a_tuple = {:foo, :bar}
  ...
  # TODO: why is this a test, and why does it not run/fail when I change "test" to "think"
